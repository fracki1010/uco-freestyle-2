...
* The original package name 'com.uco-freestyle2.ucoFreestyle2' is invalid and this project uses 'com.ucofreestyle2.ucoFreestyle2' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.1.10-SNAPSHOT/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
